...
(def part1 (calculate-total input-prep (repeating-subsequence-compsed-string? "^(.+)\\1$")))

(def part2 (calculate-total input-prep (repeating-subsequence-compsed-string? "^(.+)\\1+$")))
